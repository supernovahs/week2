...
describe('Custom Tests', function () {
    ...
    it('should deposit from L1 and withdraw to L1', async function () {
        ...
        // withdrawing 0.08 ETH from alice 
